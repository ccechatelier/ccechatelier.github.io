...
with open('scholar_profile_intermediaire.json', 'r') as file:
    data = json.load(file)
    publications = data['publications']

for pub in publications:
    pub['index'] = len(publications) - pub['index'] + 1

# Save the updated publications data to the JSON file
with open('scholar_profile_v2.json', 'w') as f:
    data['publications'] = publications
    json.dump(data, f, indent=2)

print("[INFO] Updated scholar_profile_v2.json with new publication indices")
